...
def process_videos(video_path_left, video_path_right, start_frame=0):
    ...
    camera_params_path = r'D:\projects\01jobs\002skeleton\20241025\stereo_camera_calibration.npz'
    if not os.path.exists(camera_params_path):
        print('camera_params_path is error.')
        return
    mtx_left, dist_left, mtx_right, dist_right, _, _ = load_camera_params(camera_params_path)
    ...
    model_asset_path = r"D:\projects\01jobs\002skeleton\20241025\pose_landmarker_full.task"
